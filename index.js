...
app.get('/sim', (req, res) => {
  ...
  if (teachQuery) {
    ...
    if (response) {
      ...
      console.log('\x1b[31m', '\n   Author: Mohammed Rahad'); console.log('\x1b[31m', `   Message: ${notFoundResponse.message}`);
            console.log('\x1b[34m', `   IP Address: ${clientIp}`);
      ...
      app.listen(port, () => {
        console.log('\x1b[32m', ' \x1b[31mRahad \x1b[32m \x1b[33mServer \x1b[32m \x1b[36mStart\x1b[32m \x1b[34mSuccessful\n',
          '┌──────────────── •✧ • ────────────────┐');
        console.log('\x1b[35m', '\n  ____      _    _   _    _    ____  ');
